            ...
            <ul class="agendamento">
                ...
                <a href="./Paginas_Agendamento/mostraServicos.php">
                    <li>
                        ...
                        <img src="../img/img.jpg">
                        <p class="agendamento-descricao">Sem preferencia de corte</p>
                        <br>
            ...
            <div class="item">
                <div class="page">
                    ...
                    <div class="wrapper">
                        ...
                        <a href="https://web.whatsapp.com/send?phone=15 99849-0468" class="button">
                           <div class="icon">
            ...
            <div id="comentarios">
                ...
                <form action="#" method="post" id="avaliacaoTotal">
                    <div class="estrelas">
                        ...
                        <textarea name="mensagem" id="" cols="20" rows="4"
